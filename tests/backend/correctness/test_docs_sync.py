"""Ensure registered methods have research docs and info.json."""
...
ALG_DOCS = ROOT / "platform" / "docs" / "guide" / "methods"
# Map method id -> docs page stem (when names differ)
DOC_BY_ID = {
...
def test_each_registered_method_has_info_and_docs():
    for alg_id in METHODS:
        info = ROOT / "methods" / alg_id / "info.json"
