...
function parseGradientCoordinate(svg, id, defaultValue) {
  const value = svg.getAttribute(id);
  if (value == null ? void 0 : value.trim().endsWith("%")) {
...
//# sourceMappingURL=chunk-VHHLINF6.js.map
