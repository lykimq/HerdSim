...
var _RenderTarget = class _RenderTarget2 {
  ...
  _normalizeOptions(options) {
    const opts = { ..._RenderTarget2.defaultOptions, ...options };
    ...
    if (opts.depthStencilTexture instanceof Texture || opts.depthStencilTexture instanceof TextureSource) {
      if (opts.isRoot) {
  ...
  get depthStencilTexture() {
    var _a;
    return ((_a = this.depthStencilAttachment) == null ? void 0 : _a.texture) ?? null;
  }
  ...
  get colorTexture() {
    var _a;
    return (_a = this.colorAttachments[0]) == null ? void 0 : _a.texture;
  }
  /**
  ...
  get sizeSource() {
    var _a, _b;
    return ((_a = this.colorAttachments[0]) == null ? void 0 : _a.texture) ?? ((_b = this.depthStencilAttachment) == null ? void 0 : _b.texture);
  }
...
var RenderTargetSystem = class {
  ...
  bind(surfaceOrOptions, clear = true, clearColor, frame, mipLevel = 0, layer = 0, flipY) {
    ...
    const source2 = ((_a = renderTarget.colorAttachments[0]) == null ? void 0 : _a.texture) || ((_b = renderTarget.depthStencilAttachment) == null ? void 0 : _b.texture);
   ...
   * @param {number} originDest.y - the y origin of the paste
   */
  copyDepthTexture(source2, destination, originSrc, size, originDest = { x: 0, y: 0 }) {
    const sourceRenderTarget = this.getRenderTarget(source2);
...
//# sourceMappingURL=chunk-P5BQACXE.js.map
