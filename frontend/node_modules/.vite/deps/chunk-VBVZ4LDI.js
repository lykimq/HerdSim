...
function extractStructAndGroups(wgsl) {
  ...
  const groups = (_a = wgsl.match(linePattern)) == null ? void 0 : _a.map((item) => {
    ...
    const varQualifier = (varMatch == null ? void 0 : varMatch[1]) ?? "";
    let accessMode;
...
var BindGroup = class {
  ...
  setResource(resource, index) {
    ...
    if (currentResource) {
      (_a = currentResource.off) == null ? void 0 : _a.call(currentResource, "change", this.onResourceChange, this);
    }
...
var ShaderOverrides = class _ShaderOverrides {
  /**
...
var _UniformGroup = class _UniformGroup2 extends eventemitter3_default {
  /**
  ...
  set buffer(value) {
    ...
    (_a = this._buffer) == null ? void 0 : _a.off("change", this.onBufferChange, this);
    this._buffer = value;
    value == null ? void 0 : value.on("change", this.onBufferChange, this);
  }
  /**
  ...
  get _gcLastUsed() {
    var _a;
    return ((_a = this._buffer) == null ? void 0 : _a._gcLastUsed) ?? -1;
  }
...
//# sourceMappingURL=chunk-VBVZ4LDI.js.map
