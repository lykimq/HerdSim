...
This page covers the **Simulate** tab only: one live run at a time. For watching two instruments side by side, use **Compare**. For multi-seed tables and exports, use **Experiments**.
...
1. **Left:** run controls, display options, and setup (instrument, mode, seed, and optional custom factors).
...
1. Open **Simulate**.
2. Pick an **Instrument** (Strombom 2014 is a good first choice).
...
| **Custom** | You pick | Editable | Experimental factors, instrument parameters, world overrides |
...
- Instruments, Scenarios, Metrics, Environment: reference for the scientific objects
