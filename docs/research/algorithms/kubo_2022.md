...
**Matches MATLAB / paper model:** force decomposition (sheep K_s1..K_s4, dog K_f1..K_f4), sensing `radius`, `dt` integration, speed clamps, and dog update after sheep for the tick. Paper-preset agent counts default to 40 sheep and 4 dogs as declared in HerdSim's Kubo config (aligned with the reference parameter set used in this port).
