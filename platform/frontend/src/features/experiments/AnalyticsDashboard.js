import { fetchMethod, fetchBenchmarkDefinitions, runBenchmark, exportBenchmark } from '../../shared/api/rest.js';
import {
  methodBlurb,
  downloadText,
  presetSourceBlurb,
...
export function createAnalyticsDashboard({ methods, scenarios, models = null, globalState }) {
  ...
  const defaultMethodIds = new Set(
    DEFAULT_BENCHMARK_METHOD_IDS.filter((id) => methods.some((a) => a.id === id)),
  );
