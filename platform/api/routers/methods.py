"""API router for method / preset discovery."""
...
@router.get("/")
def list_methods():
    """List named method presets (sheep_model x dog_controller bundles)."""
    return [_with_herder_meta(item) for item in list_method_catalog()]
