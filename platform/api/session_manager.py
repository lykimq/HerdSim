...
class SessionManager:
    ...
    def create_session(self, runner: SimulationRunner) -> str:
        ...
        self._sessions[session_id] = SimulationSession(session_id=session_id, runner=runner)
    ...
    def list_sessions(self) -> list[dict[str, Any]]:
        return [{"session_id": s.session_id, "status": s.status} for s in self._sessions.values()]
