"""Auto-discovers and registers scenario plugins from the plugins.scenarios package."""
...
def _auto_register():
    ...
    from plugins.scenarios.split_flock import SplitFlockScenario
    from plugins.scenarios.wide_field import WideFieldScenario
